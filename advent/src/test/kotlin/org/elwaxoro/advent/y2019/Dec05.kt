 ...
 */
class Dec05 : PuzzleDayTester(5, 2019, 11193703, 12410607) {
    override fun part1(): Any = Dec5Compy(loadToInt(delimiter = ",")).run(1)
    override fun part2(): Any = Dec5Compy(loadToInt(delimiter = ",")).run(5)
